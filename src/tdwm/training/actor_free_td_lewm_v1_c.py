"""Training entry for V1 C (goal-projected TD)."""
...
def load_actor_free_td_lewm_v1_c_training_protocol(path: str | Path) -> dict[str, Any]:
    return load_actor_free_td_lewm_v1_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v1_c_training_protocol(protocol: dict[str, Any]) -> None:
    validate_actor_free_td_lewm_v1_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v1_c(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "train_actor_free_td_lewm_v1_c",
    "validate_actor_free_td_lewm_v1_c_training_protocol",
]
