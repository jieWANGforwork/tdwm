"""Training entry for V2-EMA-SG method G2."""
...
METHOD = "actor_free_td_lewm_v2_ema_sg_g2"
VARIANT = "g2"
SPEC = V2_EMA_SG_SPECS[VARIANT]


def load_actor_free_td_lewm_v2_ema_sg_g2_training_protocol(
    path: str | Path,
) -> dict[str, Any]:
    return load_actor_free_td_lewm_v2_ema_sg_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v2_ema_sg_g2_training_protocol(
    protocol: dict[str, Any],
) -> None:
    validate_actor_free_td_lewm_v2_ema_sg_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v2_ema_sg_g2(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "validate_actor_free_td_lewm_v2_ema_sg_g2_training_protocol",
]
