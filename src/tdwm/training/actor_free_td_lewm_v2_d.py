"""Training entry for V2 D coupled-Hybrid fine-tuning."""
...
def load_actor_free_td_lewm_v2_d_training_protocol(
    path: str | Path,
) -> dict[str, Any]:
    return load_actor_free_td_lewm_v2_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v2_d_training_protocol(
    protocol: dict[str, Any],
) -> None:
    validate_actor_free_td_lewm_v2_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v2_d(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "validate_actor_free_td_lewm_v2_d_training_protocol",
]
