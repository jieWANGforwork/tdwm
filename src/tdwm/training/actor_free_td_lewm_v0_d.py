"""Training entry for V0 D (goal-value-weighted TD)."""
...
METHOD = "actor_free_td_lewm_v0_d"
VARIANT = "d"
SPEC = V0_SPECS[VARIANT]


def load_actor_free_td_lewm_v0_d_training_protocol(path: str | Path) -> dict[str, Any]:
    return load_actor_free_td_lewm_v0_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v0_d_training_protocol(protocol: dict[str, Any]) -> None:
    validate_actor_free_td_lewm_v0_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v0_d(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "validate_actor_free_td_lewm_v0_d_training_protocol",
]
