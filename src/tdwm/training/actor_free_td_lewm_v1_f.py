"""Training entry for V1 F (same-future/different-goal advantage)."""
...
METHOD = "actor_free_td_lewm_v1_f"
VARIANT = "f"
SPEC = V1_SPECS[VARIANT]


def load_actor_free_td_lewm_v1_f_training_protocol(path: str | Path) -> dict[str, Any]:
    return load_actor_free_td_lewm_v1_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v1_f_training_protocol(protocol: dict[str, Any]) -> None:
    validate_actor_free_td_lewm_v1_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v1_f(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "validate_actor_free_td_lewm_v1_f_training_protocol",
]
