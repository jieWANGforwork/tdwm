"""Training entry for V2 G2 coupled-Hybrid fine-tuning."""
...
def load_actor_free_td_lewm_v2_g2_training_protocol(
    path: str | Path,
) -> dict[str, Any]:
    return load_actor_free_td_lewm_v2_training_protocol(path, spec=SPEC)


def validate_actor_free_td_lewm_v2_g2_training_protocol(
    protocol: dict[str, Any],
) -> None:
    validate_actor_free_td_lewm_v2_training_protocol(protocol, spec=SPEC)


def train_actor_free_td_lewm_v2_g2(**kwargs: Any) -> dict[str, Any]:
...
__all__ = [
    ...
    "SPEC",
    "VARIANT",
    "load_actor_free_td_lewm_v2_g2_training_protocol",
    "train_actor_free_td_lewm_v2_g2",
    "validate_actor_free_td_lewm_v2_g2_training_protocol",
]
