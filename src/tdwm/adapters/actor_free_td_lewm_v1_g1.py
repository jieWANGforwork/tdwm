"""Deployment adapter for Actor-Free TD-LeWM V1 G1."""
...
METHOD = "actor_free_td_lewm_v1_g1"
VARIANT = "g1"
...
METHOD_SPEC = FrozenActorFreeTDV1MethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM V1 G1",
    objective_keys=(
        "weight_temperature",
...
def load_actor_free_td_lewm_v1_g1_checkpoint(
...
def make_actor_free_td_lewm_v1_g1_policy(**kwargs):
