"""Deployment adapter for Actor-Free TD-LeWM V2-EMA-SG D."""
...
from tdwm.adapters.actor_free_td_lewm_v2_d import METHOD_SPEC as V2_METHOD_SPEC
...
def load_actor_free_td_lewm_v2_ema_sg_d_checkpoint(
...
def make_actor_free_td_lewm_v2_ema_sg_d_policy(**kwargs):
