"""Deployment adapter for Actor-Free TD-LeWM V0 D."""
...
METHOD_SPEC = FrozenActorFreeTDV0MethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM V0 D",
    objective_keys=("weight_temperature",),
    validate_method_config=_validate_method_config,
)


def load_actor_free_td_lewm_v0_d_checkpoint(
...
def make_actor_free_td_lewm_v0_d_policy(**kwargs):
