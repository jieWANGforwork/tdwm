"""Deployment adapter for Actor-Free TD-LeWM V2-EMA-SG C."""
...
from tdwm.adapters.actor_free_td_lewm_v2_c import METHOD_SPEC as V2_METHOD_SPEC
...
def load_actor_free_td_lewm_v2_ema_sg_c_checkpoint(
...
def make_actor_free_td_lewm_v2_ema_sg_c_policy(**kwargs):
