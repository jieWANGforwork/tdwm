"""Deployment adapter for Actor-Free TD-LeWM V2-EMA-SG G3."""
...
from tdwm.adapters.actor_free_td_lewm_v2_g3 import METHOD_SPEC as V2_METHOD_SPEC
...
def load_actor_free_td_lewm_v2_ema_sg_g3_checkpoint(
...
def make_actor_free_td_lewm_v2_ema_sg_g3_policy(**kwargs):
