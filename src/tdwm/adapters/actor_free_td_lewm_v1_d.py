"""Deployment adapter for Actor-Free TD-LeWM V1 D."""
...
METHOD_SPEC = FrozenActorFreeTDV1MethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM V1 D",
    objective_keys=("weight_temperature",),
    validate_method_config=_validate_method_config,
)


def load_actor_free_td_lewm_v1_d_checkpoint(
...
def make_actor_free_td_lewm_v1_d_policy(**kwargs):
