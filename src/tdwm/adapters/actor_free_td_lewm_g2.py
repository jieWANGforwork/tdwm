"""Planning adapter for the independent Actor-Free TD-LeWM G2 method."""
...
METHOD_SPEC = FrozenActorFreeTDMethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM G2",
    objective_keys=(
        "candidate_source",
...
def load_actor_free_td_lewm_g2_checkpoint(
...
def make_actor_free_td_lewm_g2_policy(**kwargs):
