"""Deployment adapter for Actor-Free TD-LeWM V1 F."""
...
METHOD_SPEC = FrozenActorFreeTDV1MethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM V1 F",
    objective_keys=("weight_temperature",),
    validate_method_config=_validate_method_config,
)


def load_actor_free_td_lewm_v1_f_checkpoint(
...
def make_actor_free_td_lewm_v1_f_policy(**kwargs):
