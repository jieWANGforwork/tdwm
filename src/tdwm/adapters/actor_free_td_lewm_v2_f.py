"""Deployment adapter for Actor-Free TD-LeWM V2 F."""
...
METHOD_SPEC = ActorFreeTDV2MethodSpec(
    method=METHOD,
    variant=VARIANT,
    display_name="Actor-Free TD-LeWM V2 F",
    objective_keys=("weight_temperature",),
    validate_method_config=_validate_method_config,
)


def load_actor_free_td_lewm_v2_f_checkpoint(
...
def make_actor_free_td_lewm_v2_f_policy(**kwargs):
