"""Controlled Cube evaluation for Actor-Free TD-LeWM V0 G2."""
...
from tdwm.adapters.actor_free_td_lewm_v0_g2 import (
...
def validate_actor_free_td_lewm_v0_g2_evaluation_protocol(protocol) -> None:
    validate_frozen_actor_free_td_v0_evaluation_protocol(protocol, spec=METHOD_SPEC)


def load_actor_free_td_lewm_v0_g2_evaluation_protocol(
    path: str | Path,
) -> dict[str, Any]:
    return load_frozen_actor_free_td_v0_evaluation_protocol(path, spec=METHOD_SPEC)


def validate_actor_free_td_lewm_v0_g2_checkpoint_protocol(**kwargs) -> None:
    validate_frozen_actor_free_td_v0_checkpoint_protocol(spec=METHOD_SPEC, **kwargs)


def configure_actor_free_td_lewm_v0_g2_evaluation_mode(protocol, **kwargs):
    return configure_frozen_actor_free_td_v0_evaluation_mode(protocol, **kwargs)


def evaluate_actor_free_td_lewm_v0_g2(**kwargs) -> dict[str, Any]:
    return evaluate_frozen_actor_free_td_v0(
        spec=METHOD_SPEC,
        checkpoint_loader=load_actor_free_td_lewm_v0_g2_checkpoint,
        policy_factory=make_actor_free_td_lewm_v0_g2_policy,
        **kwargs,
    )
...
__all__ = [
    ...
    "OBJECTIVE_VERSION",
    "VARIANT",
    "configure_actor_free_td_lewm_v0_g2_evaluation_mode",
    "evaluate_actor_free_td_lewm_v0_g2",
    "load_actor_free_td_lewm_v0_g2_evaluation_protocol",
    "validate_actor_free_td_lewm_v0_g2_checkpoint_protocol",
    "validate_actor_free_td_lewm_v0_g2_evaluation_protocol",
]
