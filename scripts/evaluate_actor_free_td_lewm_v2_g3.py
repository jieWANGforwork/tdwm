...
from tdwm.evaluation.actor_free_td_lewm_v2_g3 import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate Actor-Free TD-LeWM V2 G3 with policy-free CEM."
    )
...
def main() -> None:
    ...
    if output_dir is None:
        protocol = load_actor_free_td_lewm_v2_g3_evaluation_protocol(args.config)
    ...
    result = evaluate_actor_free_td_lewm_v2_g3(
