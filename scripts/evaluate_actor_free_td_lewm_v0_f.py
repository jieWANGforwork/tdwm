...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate Actor-Free TD-LeWM V0 F with policy-free CEM."
    )
...
def main() -> None:
    ...
    if output_dir is None:
        protocol = load_actor_free_td_lewm_v0_f_evaluation_protocol(args.config)
    ...
    result = evaluate_actor_free_td_lewm_v0_f(
