#!/usr/bin/env python3
"""Train Actor-Free TD-JEPA V0 method G2."""

from tdwm.training.actor_free_td_lewm_v0_g2 import (
...
def main() -> None:
    run_frozen_actor_free_td_cli(
        ...
        load_protocol=load_actor_free_td_lewm_v0_g2_training_protocol,
        train=train_actor_free_td_lewm_v0_g2,
    )
